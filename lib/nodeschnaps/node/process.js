...
{
    require('timers').setImmediate.apply(arguments);
}
    ...
    set : function(value) {
        ...
        if (_immediateCallback instanceof Function) {
            ...
            setTimeout(function immediateCallbackWrapper() {
                while (true === self._needImmediateCallback) {
                    _immediateCallback();
                }
                _immediateCallback = null;
            });
        }
    }
});
